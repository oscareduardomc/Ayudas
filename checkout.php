...
$varsesion = $_SESSION['shopping_cart'];

if ($varsesion == null || $varsesion = '') {
  header('Location: index.php');
}

$arreglo = $_SESSION['shopping_cart'];
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="row mb-5">
              <div class="col-md-12">
                <h2 class="h3 mb-3 text-black">Tú orden</h2>
                <div class="p-3 p-lg-5 border">
                  <table class="table site-block-order-table mb-5">
                    ...
                    <tbody>
                      ...
                      for ($i = 0; $i < count($arreglo); $i++) {
                        $total = $total + ($arreglo[$i]['item_price'] * $arreglo[$i]['item_quantity']);
                      ?>
                        <tr>
                          <td><?php echo $arreglo[$i]["item_name"], " x", $arreglo[$i]["item_quantity"]; ?></td>
                          <td>L<?php echo number_format($arreglo[$i]["item_quantity"] * $arreglo[$i]["item_price"], 2); ?></td>
                        </tr>
                      <?php
                      }
                      ?>
                      ...
                      <tr>
                        ...
                        <td class="text-black">L<?php echo number_format($total, 2); ?></td>
                      </tr>
                      <tr>
                        <td class="text-black font-weight-bold"><strong>Total</strong></td>
                        <td class="text-black font-weight-bold"><strong>L<?php echo number_format($total, 2); ?></strong></td>
                      </tr>
                    </tbody>
                  </table>
